...
- Bi-directional Linking - Links that make both destination and source visible, creating two-way contextual navigation.
- Epistemic Status - Metadata indicating the level of certainty, maturity, or done-ness of a note.

If recommending promotion, keep these as new candidates. Use `### Evergreen Note` as the candidate concept heading, and use `NEW CANDIDATE: Evergreen Note` outside that heading instead of a wikilink.

## Topic Guidance

This packet should explore Andy Matuschak's evergreen notes philosophy in depth.

Focus on:

- What makes evergreen notes different from conventional note-taking, transient notes, fleeting notes, and literature notes.
- The core principles: atomicity, concept-orientation, dense linking, writing in your own words, and bottom-up composition.
- How evergreen notes relate to the trusted Digital Garden concept.
- Whether `Evergreen Note` deserves promotion as a standalone trusted concept in this vault, or whether it is better understood as a practice/property within Digital Garden.
- The relationship between evergreen notes and bottom-up knowledge composition: writing as thinking, idea emergence from linked notes, and accumulating insight over time.
- The generation effect and how writing in your own words supports memory and understanding.
- Practical affordances of tools like Obsidian and Roam Research.

Pay special attention to tensions:

- Does the evergreen notes system risk becoming over-ritualistic maintenance labor?
- How does it interact with the garden metaphor: tending vs optimizing?
- Is there a meaningful difference between `Evergreen Note` and `Concept Note` as this vault uses the term?
